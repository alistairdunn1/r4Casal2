...
#' @export
"get_derived_quantities.casal2MPD" <- function(model) {
  # can be -r or -r -i
...
#' @export
"get_derived_quantities.list" <- function(model) {
  ...
  for (i in 1:length(model)) {
    ...
    this_dq <- get_derived_quantities(model[[i]])
...
#' @export
"get_derived_quantities.casal2TAB" <- function(model) {
